...
(function (global) {
  ...
  function handleResponse(request, callback, isJsonResponse) {
    if (request.readyState === 4 && request.status === 200) {
      var responseData = isJsonResponse ? JSON.parse(request.responseText) : request.responseText;
  ...
  function buildMenuItemsViewHtml(categoryMenuItems,
    ...
    menuItemHtml) {
      ...
      if (!categoryMenuItems || !categoryMenuItems.category) {
        console.error('Category menu items or category is null or undefined.');
        return '';
    }
